...
export default function AsymetricGrid() {
  return (
    <image-grid class="grid grid-cols-1 text-neutral-50 md:grid-cols-2 md:grid-rows-2 md:p-6 md:gap-6 md:text-neutral-900">
      <div class="relative overflow-hidden md:rounded-lg cursor-pointer group md:row-span-2 h-[75vh] md:h-full">
        <RespImage
          ...
          class="object-cover object-center h-full group-hover:opacity-75 "
        />
        <div
          aria-hidden="true"
          class="absolute inset-0 opacity-50 bg-gradient-to-b from-transparent to-black md:hidden"
        />
